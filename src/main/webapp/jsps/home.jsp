...
<h1 align="center"> Mithun Technologies- Very Good Training center for DevOps & Cloud. CI CD with jenkins. building application, building image with docker and pushing image to Docker hub and deploy with k8s. </h1>
